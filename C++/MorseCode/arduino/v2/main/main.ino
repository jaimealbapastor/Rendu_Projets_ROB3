...
void loop()
{
  ...
  if (Serial.available() && !ongoingBlinking)
  {            // wait to finish the previous blinking
  ...
  else if (ongoingBlinking && millis() - startMillis >= INTERVAL)
  {                          // if we arrive at the end of the translation
